...
/**
 * 전도 월간보고(활동자수/교사수) 수정 요청 엔티티 — EvangelismEditRequest와 동일한 관례,
 * 잠긴(이번 달이 아닌) 월의 월간보고 데이터를 수정하기 위한 결재 요청.
 */
@Entity
@Table(name = "evangelism_monthly_activity_edit_request", schema = "overseas")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Comment("전도 월간보고 수정 허용 요청 및 결재 내역")
public class EvangelismMonthlyActivityEditRequest {
